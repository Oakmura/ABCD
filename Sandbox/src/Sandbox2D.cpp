...
void Sandbox2D::OnUpdate(abcd::Timestep ts)
{
...

    {
        ...
        abcd::Renderer2D::BeginScene(mCameraController.GetCamera());
        {
            ...
            abcd::Renderer2D::DrawQuad({ -5.0f, -5.0f, -0.1f }, { 10.0f, 10.0f }, mCheckerboardTexture, 10.0f);
            abcd::Renderer2D::DrawQuad({ -0.5f, -0.5f, 0.0f }, { 1.0f, 1.0f }, mCheckerboardTexture, 20.0f);
        }
